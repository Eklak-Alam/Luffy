...
export default function DevOpsProjects() {
  ...
  return (
    <section 
      id="infrastructure" 
      ref={sectionRef} 
      // Matched padding exactly to the main Projects component for perfect scroll rhythm
              ...
              >
                ...
                >
                  <div className="flex-1 flex items-center gap-4 sm:gap-6 md:gap-10 transition-transform duration-500 ease-out md:group-hover:translate-x-4 pr-4 min-w-0">
                    ...
                    {/* THE FIX: pb-1 md:pb-2 and leading-tight added so the bottom of letters are never cut off */}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="w-full max-w-2xl mx-auto lg:max-w-none lg:mx-0 lg:w-[52%] flex flex-col justify-center min-w-0">
                          ...
                          {/* ACTION BLOCK: Fully split and responsive */}
                          <div className="flex flex-wrap items-center justify-between w-full gap-y-4 gap-x-4 mt-2">
                            
                            {/* Primary Button */}
                            <a 
                              href={`/case-study/${project.slug}`} 
                              className="relative overflow-hidden inline-flex items-center gap-2 px-5 py-2.5 md:px-6 md:py-3 bg-foreground text-background text-xs sm:text-sm md:text-base font-bold rounded-full transition-all duration-300 active:scale-95 group/btn shadow-md shrink-0"
                            >
                              <span className="absolute inset-0 bg-primary translate-y-[101%] group-hover/btn:translate-y-0 transition-transform duration-300 ease-out z-0 rounded-full" />
                              <span className="relative z-10 flex items-center gap-2 group-hover/btn:text-primary-text transition-colors duration-300">
                                Read Case Study
